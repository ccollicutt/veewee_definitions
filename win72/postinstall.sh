...
#Install .NET 4.0
#wget http://packages.serverascode.com/windows/dotNetFx40_Full_setup.exe
#chmod 755 ./dotNetFx40_Full_setup.exe
#cmd /c /cygwin/home/vagrant/dotNetFx40_Full_setup.exe /passive

#cmd /c "@powershell -NoProfile -ExecutionPolicy unrestricted -Command "iex ((new-object net.webclient).DownloadString('http://chocolatey.org/install.ps1'))" && SET PATH=%PATH%;%systemdrive%\chocolatey\bin"
#wget --no-check-certificate https://raw.github.com/ferventcoder/chocolatey/master/chocolateyInstall/InstallChocolatey.ps1
#wget --no-check-certificate https://github.com/curtisgithub/chocolatey/raw/master/chocolateyInstall/installChocolatey.cmd
#chmod +x ./installChocolatey.cmd
#cmd /c /cygwin/home/vagrant/installChocolatey.cmd
